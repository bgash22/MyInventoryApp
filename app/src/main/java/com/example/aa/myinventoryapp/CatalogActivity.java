...
import com.example.aa.myinventoryapp.data.InventoryDbHelper;
...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //InventoryDbHelper db = new PetDbHelper(this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CatalogActivity.this, EditorActivity.class);//.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION).addFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
    ...
    private void insertPet() {
        ...
        values.put(InventoryEntry.COLUMN_INVENTORY_SUPPLIER, "Terrier");
        values.put(InventoryEntry.COLUMN_INVENTORY_PRICE, 7.50);
