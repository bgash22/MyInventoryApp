...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertInventory(Uri uri, ContentValues values) {
        ...
        Integer type = values.getAsInteger(InventoryEntry.COLUMN_INVENTORY_TYPE);
        if (type == null || !InventoryEntry.isValidType(type)) {
            throw new IllegalArgumentException("Inventory requires valid type");
        }

        // If the quantity is provided, check that it's greater than or equal to 0 piece
    ...
    private int updateInventory(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryEntry.COLUMN_INVENTORY_TYPE)) {
            Integer type = values.getAsInteger(InventoryEntry.COLUMN_INVENTORY_TYPE);
            if (type == null || !InventoryEntry.isValidType(type)) {
                throw new IllegalArgumentException("Inventory requires valid type");
            }
